...
## 規則與接續
- `動詞て形 + もらえませんか`（委婉請求，較口語）
- `動詞て形 + いただけますか`（客氣禮貌的請求）
- `動詞て形 + いただけないでしょうか`（極為禮貌、客氣的請求，比 `いただけますか` 更委婉）
...
|---|---|---|
| 荷物（にもつ）を預（あず）かって | **荷物（にもつ）を預（あず）かってもらえませんか**。 | 能幫我寄放行李嗎？ |
| タクシーを呼（よ）んで | **タクシーを呼（よ）んでもらえませんか**。 | 能幫我叫輛計程車嗎？ |
| 傘（かさ）を貸（か）して | **傘（かさ）を貸（か）してもらえませんか**。 | 能借我雨傘嗎？ |
| 地図（ちず）を書（か）いて | **地図（ちず）を書（か）いてもらえませんか**。 | 能幫我畫張地圖嗎？ |

### 2️⃣ Transformation Drill（轉換練習）

| Transformation | Expected Response | Translation（中文翻譯） |
|---|---|---|
| 客氣禮貌請求（きゃくきれいまおせいきゅう） | 写真（しゃしん）を撮（と）って**いただけますか**。 | 可以請您幫我拍照嗎？ |
| 極其禮貌請求（ごくきれいまおせいきゅう） | 写真（しゃしん）を撮（と）って**いただけないでしょうか**。 | 能不能麻煩您幫我拍照呢？ |
| 指示命令請求（しじめいれいせいきゅう） | 写真（しゃしん）を撮（と）って**ください**。 | 請拍照。 |
| 丁寧進行（ていねいしんこう） | 写真（しゃしん）を撮（と）って**もらいました**。 | 請別人幫我拍了照片。 |

### 3️⃣ Response Drill（應答練習）

| Prompt | Expected Response | Translation（中文翻譯） |
|---|---|---|
| 写真（しゃしん）を撮（と）ってもらえませんか。 | はい、いいですよ。 | 能幫我拍張照片嗎？ / 好的，可以啊。 |
| 荷物（にもつ）を預（あず）かってもらえませんか。 | はい、いいですよ。 | 能幫我寄放行李嗎？ / 好的，可以啊。 |
| タクシーを呼（よ）んでもらえませんか。 | はい、いいですよ。 | 能幫我叫輛計程車嗎？ / 好的，可以啊。 |

### 4️⃣ Expansion Drill（擴展練習）

| Step | Sentence | Translation（中文翻譯） |
|---|---|---|
| 核心（かくしん） | もらえませんか。 | 可以幫我嗎？ |
| +動作（どうさ） | 撮（と）ってもらえませんか。 | 能幫我拍嗎？ |
| +目的語（もくてきご） | 写真（しゃしん）を撮（と）ってもらえませんか。 | 能幫我拍張照片嗎？ |
| +修飾（しゅうしょく） | 一緒（いっしょ）に写真（しゃしん）を撮（と）ってもらえませんか。 | 能不能一起拍張照片呢？ |
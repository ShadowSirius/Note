...
## 規則與接續
- `名詞（身分・立場） + に + あるまじき + 名詞`（連體修飾，常見「〜として」呼應：「教師としてあるまじき」）
...
- 日文：<span style="color:#2ECC71">これは</span><span style="color:#FF477E"><ruby>教師<rt>きょうし</rt></ruby>にあるまじき</span><span style="color:#3498DB"><ruby>行為<rt>こうい</rt></ruby>だ。</span>
  中文：這是身為教師不該有的行為。
- 日文：<span style="color:#2ECC71">それは</span><span style="color:#FF477E"><ruby>公務員<rt>こうむいん</rt></ruby>にあるまじき</span><span style="color:#3498DB"><ruby>発言<rt>はつげん</rt></ruby>だった。</span>
  中文：那是身為公務員不該有的發言。

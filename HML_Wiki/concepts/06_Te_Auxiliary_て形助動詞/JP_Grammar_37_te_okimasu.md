...
## 規則與接續
- `動詞て形 + おきます`
- 常用縮略形（口語）：`〜とく`（例如 `予約しておく` 縮讀為 `予約しとく`）

## 用法說明
主要有以下三種含意：
1. **事前準備**：為了某個特定目的，而「事先做好準備工作」。
2. **事後處置**：為了下一次使用方便，而「將狀態恢復原狀或做適當處置」。
3. **維持現狀**：保持當前動作狀態「放任不管」。
...
|---|---|---|
| 切符（きっぷ） | 前（まえ）もって**切符（きっぷ）**を予約（よやく）しておきます。 | 事先預約好車票。 |
| チケット | 前（まえ）もって**チケット**を予約（よやく）しておきます。 | 事先預約好門票。 |
| 飛行機（ひこうき） | 前（まえ）もって**飛行機（ひこうき）**を予約（よやく）しておきます。 | 事先預約好機票。 |
| レストラン | 前（まえ）もって**レストラン**を予約（よやく）しておきます。 | 事先預約好餐廳。 |

### 2️⃣ Transformation Drill（轉換練習）

| Transformation | Expected Response | Translation（中文翻譯） |
|---|---|---|
| 過去形（かこけい） | 前（まえ）もってホテルを予約（よやく）して**おきました**。 | 事先預約好飯店了。 |
| 請求（せいきゅう） | 前（まえ）もってホテルを予約（よやく）して**おいてください**。 | 請事先預約好飯店。 |
| 否定形（ひていけい） | 前（まえ）もってホテルを予約（よやく）して**おきません**。 | 不事先預約好飯店。 |
| 義務（ぎむ） | 前（まえ）もってホテルを予約（よやく）して**おかないと**。 | 必須事先預約好飯店。 |

### 3️⃣ Response Drill（應答練習）

| Prompt | Expected Response | Translation（中文翻譯） |
|---|---|---|
| ホテルはもう予約（よやく）しておきましたか。 | はい、予約（よやく）しておきました。 | 飯店已經預約好了嗎？ / 是的，已經預約好了。 |
| 会議（かいぎ）の前（まえ）に資料（しりょう）を準備（じゅんび）しておきますか。 | はい、準備（じゅんび）しておきます。 | 開會前會先準備好資料嗎？ / 是的，會先準備好。 |
| 電池（でんち）はもう換（か）えておきましたか。 | はい、もう換（か）えておきました。 | 電池已經換好了嗎？ / 是的，已經換好了。 |

### 4️⃣ Expansion Drill（擴展練習）

| Step | Sentence | Translation（中文翻譯） |
|---|---|---|
| 核心（かくしん） | 予約（よやく）しておきます。 | 預約好。 |
| +目的語（もくてきご） | ホテルを予約（よやく）しておきます。 | 預約好飯店。 |
| +副詞（ふくし） | 前（まえ）もってホテルを予約（よやく）しておきます。 | 事先預約好飯店。 |
| +修飾（しゅうしょく） | 友達（ともだち）のために前（まえ）もってホテルを予約（よやく）しておきます。 | 為了朋友事先預約好飯店。 |
